    ...
    <>
      ...
      <ScrollView>
        <View className="relative">
          ...
          <TouchableOpacity className="absolute top-8 left-4 p-2 bg-gray-100 rounded-full" onPress={navigation.goBack}>
        ...
        <View className="bg-white">
          <View className="px-4 pt-4">
              ...
              <View className="flex-row space-x-2 my-1">
                  ...
                  <View className="flex-row items-center space-x-1 w-60">
